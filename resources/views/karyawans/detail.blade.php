                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-center flex-column py-5">
                                        <div class="symbol symbol-100px symbol-circle mb-7">
                                            @if($karyawan->foto)
                                                <img src="{{ asset('fotos/' . $karyawan->foto) }}" alt="image" />
                                            @else
                                                <img src="{{ asset('fotos/default.png') }}" alt="image" />
                                            @endif
                                        </div>
                                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{ $karyawan->nama }}</a>
                                        <div class="mb-9">
                                            <div class="badge badge-lg badge-light-primary d-inline">{{ $karyawan->role }}</div>
                                        </div>
                                    ...
                                    <div class="d-flex flex-stack fs-4 py-3">
                                        ...
                                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit customer details">
                                            <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_user" onclick="editUser('{{ $karyawan->id }}', '{{ $karyawan->nama }}', '{{ $karyawan->username }}', '{{ $karyawan->password }}', '{{ $karyawan->role }}', '{{ $karyawan->no_telp }}')">Edit</a>
                                        </span>
                                    </div>
                                    <div class="separator"></div>
                                    <div id="kt_user_view_details" class="collapse show">
                                        <div class="pb-5 fs-6">
                                            <div class="fw-bold mt-5">Usename</div>
                                            <div class="text-gray-600">{{$karyawan->username}}</div>
                                            <div class="fw-bold mt-5">Password</div>
                                            <div class="text-gray-600">********</div>
                                            <div class="fw-bold mt-5">No Telepon</div>
                                            <div class="text-gray-600">{{$karyawan->no_telp}}</div>
                                        </div>
                                    </div>
                                    @endif
                                </div>
                                                ...
                                                <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>POST /v1/invoices/in_4700_9448/payment</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>POST /v1/invoice/in_3246_2038/invalid</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>POST /v1/customer/c_66066345eb2e5/not_found</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>POST /v1/invoices/in_3882_5706/payment</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>POST /v1/invoices/in_8803_4962/payment</td>
                                                            <td class="pe-0 text-end min-w-200px">15 Apr 2024, 9:23 pm</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <!--end::Table-->
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a href="#" class="fw-bold text-gray-900 text-hover-primary">#XRS-45670</a></td>
                                                        <td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2024, 6:43 am</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="min-w-400px">Invoice 
                                                        ...
                                                        <td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2024, 10:10 pm</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="min-w-400px">Invoice 
                                                        <a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#KIO-45656</a>status has changed from 
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            <div class="modal-content">
                                ...
                                <div class="modal-body px-5 my-7">
                                    <form id="kt_modal_edit_user_form" class="form" action="" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_edit_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_user_header" data-kt-scroll-wrappers="#kt_modal_edit_user_scroll" data-kt-scroll-offset="300px">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="nama" id="edit_nama" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" />
                                            </div>
                                            <div class="fv-row mb-7">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <div class="d-flex fv-row">
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label" for="edit_role_developer">
                                                            <div class="fw-bold text-gray-800">Software Developer</div>
                                                ...
                                                <div class="d-flex fv-row">
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label" for="edit_role_support">
                                                            <div class="fw-bold text-gray-800">Customer Support</div>
                                                            <div class="text-gray-600">memberikan bantuan teknis dan dukungan kepada pelanggan untuk masalah atau pertanyaan terkait produk atau layanan</div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class='separator separator-dashed my-5'></div>
                                                <div class="d-flex fv-row">
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input me-3" name="role" type="radio" value="Trial" id="edit_role_trial" />
                                                        <label class="form-check-label" for="edit_role_trial">
                                                            <div class="fw-bold text-gray-800">Trial User</div>
                                                            <div class="text-gray-600">pengguna yang berada dalam periode percobaan untuk menilai fitur dan fungsionalitas sebelum berkomitmen sepenuhnya</div>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="password" name="password" id="edit_password" class="form-control form-control-solid" placeholder="Password" />
                                            </div>
                                            <div class="fv-row mb-7">
                                                <label class="required fw-semibold fs-6 mb-2">No Telp</label>
                                                <input type="text" name="no_telp" id="edit_no_telp" class="form-control form-control-solid" placeholder="No Telp" />
                                            </div>
                                        </div>
                                        <div class="text-center pt-15">
                                            <button type="reset" id="kt_modal_edit_user_cancel" class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</button>
...
<script>
   function editUser(id, nama, username, password, role, no_telp, foto) {
    ...
    document.querySelector(`#edit_role_${role.toLowerCase()}`).checked = true;

    document.querySelector('#edit_no_telp').value = no_telp;

    if (foto) {
        document.querySelector('#edit_image_preview').style.backgroundImage = `url('/storage/fotos/${foto}')`;
    } else {
        document.querySelector('#edit_image_preview').style.backgroundImage = `url('/assets/media/svg/files/blank-image.svg')`;
    }
}
