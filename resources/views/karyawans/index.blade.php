                                ...
                                <form id="kt_modal_add_user_form" class="form" action="{{ route('karyawans.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="nama" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" />
                                        </div>
                                        <div class="fv-row mb-7">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="number" name="no_telp" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="No. Telp" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                <div class="menu-item px-3">
                                    <a href="{{route('karyawans.detail', $karyawan->id)}}" class="btn  menu-link px-3 btn-sm me-1">
                                     Detail
                                    </a>
                                </div>
                                <div class="menu-item px-3">
...
<script>
    ...
    form.addEventListener('submit', function(event) {
        ...
        if (nama.value.trim() === '') {
            ...
            error.textContent = 'Nama harus diisi.';
            nama.parentElement.appendChild(error);
            valid = false;
        }
        ...
        if (username.value.trim() === '') {
            ...
            var error = document.createElement('div');
            error.classList.add('invalid-feedback');
            error.textContent = 'Username harus diisi.';
        ...
        if (password.value.trim() === '') {
            ...
            var error = document.createElement('div');
            error.classList.add('invalid-feedback');
            error.textContent = 'Password harus diisi.';
        ...
        if (noTelp.value.trim() === '') {
            ...
            var error = document.createElement('div');
            error.classList.add('invalid-feedback');
            error.textContent = 'No. Telp harus diisi.';
            noTelp.parentElement.appendChild(error);
            valid = false;
        }
        ...
        if (!roleChecked) {
            form.querySelector('div.mb-7').insertAdjacentHTML('beforeend', '<div class="invalid-feedback">Role harus dipilih.</div>');
            valid = false;
        }

        // Jika tidak valid, batalkan pengiriman form
        if (!valid) {
